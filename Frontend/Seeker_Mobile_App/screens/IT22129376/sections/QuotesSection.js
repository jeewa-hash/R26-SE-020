      ...
      {groups.map((group) => {
        ...
        return (
          <View key={group.sessionId} style={[styles.group, isDarkMode && styles.groupDark]}>
            ...
            <Text style={styles.meta}>{group.quotes.length} quotation{group.quotes.length === 1 ? '' : 's'} received</Text>
...
const styles = StyleSheet.create({
  ...
  meta: { color: '#64748B', fontWeight: '700', marginTop: 3, marginBottom: 10 },
  ...
  compareText: { color: '#4F46E5', fontWeight: '900' },
  comparison: { backgroundColor: '#ECFDF5', padding: 12, borderRadius: 12, marginBottom: 12 },
  average: { color: '#047857', fontWeight: '900', marginBottom: 8 },
