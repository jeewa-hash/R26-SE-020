...
export const CONFIG = {
  ...
  SERVICE_COORDINATION_SERVICE_URL: `http://${IP_ADDRESS}:5010/coordination`,
  PROVIDER_SERVICE_BASE_URL: `http://${IP_ADDRESS}:3002`
};
...
export const SERVICE_COORDINATION_SERVICE_URL = CONFIG.SERVICE_COORDINATION_SERVICE_URL;
export const PROVIDER_SERVICE_BASE_URL = CONFIG.PROVIDER_SERVICE_BASE_URL;
